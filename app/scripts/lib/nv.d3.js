      ...
      switch (axis.orient()) {
        ...
        case 'right':
          axisLabel.enter().append('text').attr('class', 'nv-axislabel')
              ...
              .attr('y', rotateYLabel ? (-Math.max(margin.right,width) + 30) : -10); //TODO: consider calculating this based on largest tick width... OR at least expose this on chart
          axisLabel
        ...
        case 'left':
          ...
          */
          axisLabel.enter().append('text').attr('class', 'nv-axislabel')
              ...
              .attr('transform', rotateYLabel ? 'rotate(-90)' : '')
              .attr('y', rotateYLabel ? (-Math.max(margin.left,width) + 30) : -10); //TODO: consider calculating this based on largest tick width... OR at least expose this on chart
          axisLabel
              .attr('x', rotateYLabel ? (-scale.range()[0] / 2) : -axis.tickPadding());
          if (showMaxMin) {
            var axisMaxMin = wrap.selectAll('g.nv-axisMaxMin')
